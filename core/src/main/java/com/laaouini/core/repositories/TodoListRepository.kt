package com.laaouini.core.repositories

import com.laaouini.core.database.TodoListDao
...
class TodoListRepositoryImpl(private val todoListDao: com.laaouini.core.database.TodoListDao): TodoListRepository {
